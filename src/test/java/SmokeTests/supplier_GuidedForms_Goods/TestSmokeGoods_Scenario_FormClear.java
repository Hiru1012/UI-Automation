...
public class TestSmokeGoods_Scenario_FormClear extends DriverFactory{
    ...
    public void ManufactureOfGoods() throws InterruptedException {
        ...
        PageFactory.manufactureOfGoods.Button_Clear();
        PageFactory.manufactureOfGoods.Button_Clear2();

        //PageFactory.manufactureOfGoods.Button_Cancel();
